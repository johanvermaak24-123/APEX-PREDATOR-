APEX SCALP GOD 7.3.3 — FRESH ENTRY / ANTI-CHASE UPGRADE
=========================================================

PURPOSE
-------
7.3.3 fixes a specific execution-timing weakness in 7.2.0: a valid market setup could
...
The service-worker cache name was bumped to 7.3.3 so the upgraded shell replaces the
old cached version.
